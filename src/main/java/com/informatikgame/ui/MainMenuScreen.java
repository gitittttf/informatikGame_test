...
public class MainMenuScreen extends GameScreen {
    ...
    private final String subtitle = "Ein Zombie-Survival-Dungeon-Crawler";

    // Partikel-System für Hintergrund-Animation
    ...
    public void render(TextGraphics graphics) {
        ...
        for (int i = 0; i < menuOptions.length; i++) {
            ...
            if (i == selectedOption) {
                // Ausgewählte Option: animiert und hervorgehoben
